...
function atnif_default($key) {
    $defaults = array(
        ...
        'scenario_title' => 'シナリオタイトル１',
        'scenario_text' => "あらすじテキスト（300文字程度）\n・\n・\n・\n・\n・\n・",
...
function atnif_customize_register($wp_customize) {
    ...
    $text_fields = array(
        'story' => array(
            ...
            'scenario_title' => array(__('Scenario title', 'atnif-figma'), 'text'),
            'scenario_text' => array(__('Scenario text', 'atnif-figma'), 'textarea'),
        ...
        'character' => array(
            'character_name' => array(__('Character name', 'atnif-figma'), 'text'),
            'character_ruby' => array(__('Character romanization', 'atnif-figma'), 'text'),
            'character_copy' => array(__('Character description', 'atnif-figma'), 'textarea'),
        ),
        'special' => array(
